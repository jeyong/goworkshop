...
* "Value of"는 박스 내에 있는 것을 뜻하고 "Address of" ( **&** )는 박수의 위치를 말합니다.
* (*) 연산자는 포인터 변수와 "포인터가 가리키는 값"을 선언합니다.
...
**Part B** 생성한 마지막 변수에 대한 포인터로 int 타입의 포인터 변수를 선언하고 초기화합니다. 포인터가 가리키는 값과 주소를 출력합니다.
